          ...
          <i class="hamburger align-self-center"></i>
			...
			<main class="content">
				<div class="container-fluid p-0">
					...
					<h1 class="h3 mb-3">Rotate PDF</h1>
...
<header>   
  ...
  function CreateHTML() {    
      ...
      if (Analyst != undefined){
          ...
          if ((Analyst.Error || Analyst.Encrypt)){
             ...
             html += '<p>Please enter a range of pages to rotate.</p>';
             ...
             html += ' End page  <span id="input_area"><input type="number" id="end"   min="1" max="'+ Analyst.PageCount +'" required><span class="sp"><br><br><br></span>';
             html += ' Angle  <select id="rotate" style="font-size:14px;"><option value="1">Right 90</option><option value="2">Left 90</option><option value="3">180</option></select></p>';
                        
             html += '<p id ="errmsg" style="color:red;" ></p>';
             html += '<input type="submit" id="btn_start" value="Start Convert" onclick="return run();">';
          }
  ...
  function run(){   
      ...
      try {      
           PDFRotatePage.SaveToFile(PDF_GetDateTime_Now() + '.pdf', Analyst,rotate, begin, end);
           return false; 
      } catch (e) {
