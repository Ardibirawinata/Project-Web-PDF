...
<body>
                    ...
                    <div class="box">
                        ...
                        <div class="box-body table-responsive">
                            <table class="table table-stiped table-bordered">
                                ...
                                Tambah</button>
                                        <th width="5%">No</th>
                                        <th>Nama</th> <!-- Change 'Name' to 'Nama' -->
                                        <th>Bank</th> <!-- Add 'Bank' column -->
                                        <th>Nomor Rekening</th> <!-- Add 'Nomor Rekening' column -->
    ...
    columns: [
        ...
        { data: 'nama', name: 'nama' }, // Change 'name' to 'nama'
        { data: 'bank', name: 'bank' }, // Add 'bank' column
        { data: 'nomorrekening', name: 'nomorrekening', orderable: false, searchable: false }, // Add 'nomorrekening' column
        ...
        $('body').on('click', '.editStory', function() {
            var id = $(this).data('id');
            console.log(id);
            $.get("{{ route('bank.index') }}" + '/' + id + '/edit', function(data) {
